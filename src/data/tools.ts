...
export const TOOLS: Tool[] = [
  ...
  // Finance
  t("emi", "EMI Calculator", "Solves for EMI, loan amount, tenure or rate — compare any number of offers side by side, prepay to finish early or cut the EMI, prepay-vs-invest, Section 24/80C tax relief, moratorium, floating and flat rates, APR, foreclosure and a full amortization schedule.", "Finance"),
